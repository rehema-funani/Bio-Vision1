 ...
 <section className="relative bg-white  py-24 px-4 md:px-8 lg:px-12">
  ...
  <div className="flex justify-end items-center pt-1 pr-1">
    ...
    <div className="mt-10 overflow-hidden rounded-2xl shadow-lg relative z-10">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
            {[
              ...
              { name: "Red Peppers", category: "Vegetables" },
              { name: "Okra", category: "Vegetables" },
              { name: "Mangoes", category: "Fruits" },
              { name: "Green Peppers", category: "Vegetables" },
              ...
              <div key={index} className="bg-white rounded-xl shadow-md overflow-hidden border border-gray-100">
                <div className="bg-white p-4 pb-2">
                  <div className="w-full h-21 bg-gradient-to-br from-green-100 to-green-200 rounded-lg mb-2 flex items-center justify-center">
                    <span className="text-green-700 font-semibold text-xs">{product.name}</span>
                  </div>
                </div>
          ...
          <div className="bg-green-700 text-white p-10 rounded-2xl relative overflow-hidden">
            <p className="text-sm font-medium mb-2 opacity-80">Featured Products</p>
            <h2 className="text-4xl font-bold leading-tight mb-6">
              Explore <br />
              Certified <br />
      ...
      {/* Ready to Shop Section */}
      <section className="bg-white py-16 px-4 md:px-8 lg:px-12 mb-16">
        <div className="max-w-4xl mx-auto text-center relative z-10 bg-[#2E7D32] px-4 h-[250px] rounded-2xl flex flex-col justify-center">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6 leading-tight">
            Ready to shop for impact?
          </h2>
          <p className="text-lg md:text-xl text-white/90 mb-8 max-w-2xl mx-auto">
      ...
      <footer className="bg-[#24231D] py-8 px-4 md:px-8 lg:px-12">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-6">
            ...
            <div className="lg:col-span-1">
              <div className="mb-4">
                <div className="text-white text-lg font-bold">Biovision Africa Trust</div>
              </div>
              ...
              <div className="flex gap-2">
                {[1,2,3,4].map(i => (
                  <button key={i} className="w-8 h-8 bg-green-600 hover:bg-green-700 rounded-full flex items-center justify-center transition-colors duration-300">
            ...
            <div>
              <h5 className="text-base font-semibold text-white mb-4">Explore</h5>
              <ul className="space-y-2">
                {['Our Mission', 'Shop', 'Learn', 'FAQs', 'Press & Media', 'Career', 'Become a Partner'].map(link => (
                  <li key={link}>
                    <button className="text-white font-bold hover:text-gray-300 transition-colors duration-300 flex items-center text-sm">
          ...
          <div className="border-t border-gray-700 pt-4 flex flex-col md:flex-row justify-between items-center gap-3">
            ...
            <div className="flex gap-3 text-xs">
              <button className="text-yellow-500 hover:text-white transition-colors duration-300">Terms of Use</button>
              <span className="text-gray-600">|</span>
              <button className="text-yellow-500 hover:text-white transition-colors duration-300">Privacy Policy</button>
              <span className="text-gray-600">|</span>
              <button className="text-yellow-500 hover:text-white transition-colors duration-300">Cookie Policy</button>
            </div>
          </div>
        </div>
      </footer>
