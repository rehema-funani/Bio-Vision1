  ...
  {["Trainings & Workshops", "Online Webinars", "Farm Tours"].map(
    (sectionTitle, idx) => (
        ...
        <div className="flex flex-wrap justify-center sm:justify-start gap-4 sm:gap-6 sm:ml-50">
          {eventData.map((event, i) => (
            ...
            >
              ...
              />
              <div className="absolute bottom-0 left-0 right-0 h-32 sm:h-40 bg-gradient-to-t from-[#1C4C36] via-[#1C4C36cc] to-transparent" />
              <div className="absolute top-3 right-3 bg-white rounded-md text-green-600 text-xs font-semibold px-2 py-1 shadow">
                <div>{event.date}</div>
                <div className="text-[10px] uppercase">{event.month}</div>
              </div>
              <div className="absolute bottom-0 p-3 sm:p-4 text-white w-full">
                <p className="text-xs sm:text-sm mb-1">Free Webinar</p>
                <h3 className="text-base sm:text-lg font-bold leading-snug mb-1 line-clamp-2">
                  {event.title}
                </h3>
                <p className="text-xs leading-snug mb-2 line-clamp-2 opacity-90">
                  {event.description}
                </p>
                <p className="text-[10px] mb-2 sm:mb-3 opacity-80">{event.datetime}</p>
                <div className="bg-white text-green-600 text-xs font-semibold px-2 sm:px-3 py-1 rounded-full shadow inline-block">
                  {event.cta}
                </div>
              </div>
            </Link>
      ...
      >
        ...
        <Link
          href="/events"
          className="bg-white text-green-700 font-semibold px-6 py-2 rounded-full text-sm hover:bg-gray-100 transition inline-block"
        >
          View Events
        </Link>
      </div>
...
<footer className="bg-[#24231D] py-6 sm:py-8 px-4 md:px-8 lg:px-12">
    <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-6">
            ...
            <div className="w-full flex flex-col items-start md:items-end lg:items-start gap-2">
                <h3 className="text-[#FDFBF6] font-semibold text-base sm:text-lg leading-tight">
                    Explore
                </h3>
                
                {/* Green underline with dot */}
                <div className="flex items-center gap-1 mt-1 mb-3 sm:mb-4">
                    <div className="w-[35px] h-[2px] bg-[#2e7d32] rounded-sm" />
                    <div className="w-[5px] h-[5px] bg-[#2e7d32] rounded-full" />
                </div>
                
                {/* Links */}
                <div className="flex flex-col items-start md:items-end lg:items-start gap-2 w-full">
                    {[
            ...
            <div className="w-full flex flex-col gap-3">
                ...
                <div className="flex flex-col gap-2 text-[#fdfbf6] text-xs sm:text-sm leading-[22px] font-normal font-sans">
