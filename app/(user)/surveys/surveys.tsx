...
export default function Surveys() {
    ...
    return (
        <div className="min-h-screen bg-white text-gray-800">
            ...
            {/* Fixed Navbar */}
            <header className="fixed top-0 w-full z-50 bg-white border-b border-white/10">
                <div className="max-w-7xl mx-auto px-4 md:px-6 flex items-center justify-between h-16 sm:h-20 md:h-24">
                    {/* Logo */}
                    <div className="flex-shrink-0">
                        <img
                            src="/images/greenlogo.png"
                    ...
                    <div className="hidden md:flex items-center gap-2 lg:gap-4">
                        ...
                        {/* Sign Up Button */}
                        <button className="bg-green-600 hover:bg-green-700 text-white px-3 py-1.5 lg:px-6 lg:py-2 rounded-full text-xs lg:text-sm font-medium whitespace-nowrap transition">
                            Sign Up
                        </button>
