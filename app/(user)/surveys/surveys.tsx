            ...
            <main className={`relative z-10 pt-16 sm:pt-20 md:pt-24 ${showSurveyModal || showSuccessPopup ? 'blur-sm' : ''}`}>
                ...
                <section className="bg-gray-50 py-8 sm:py-12 lg:py-16 px-4">
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        {/* Filter Tags and Search */}
                        <div className="flex flex-col lg:flex-row items-center justify-center gap-4 mb-6 sm:mb-8">
                            {/* Filter buttons in a container with border */}
                            <div className="flex items-center bg-white border border-gray-200 rounded-full p-1 shadow-sm">
                                <button 
                                    onClick={() => setCurrentFilter("all")}
                                    className={`px-3 sm:px-4 py-2 rounded-full text-xs sm:text-sm transition ml-1 ${
                                        currentFilter === "all" 
                                            ? "bg-green-600 text-white hover:bg-green-700" 
                                            : "bg-gray-100 text-gray-700 hover:bg-gray-200"
                                    }`}
                             ...
                             {/* Search input */}
                             <div className="relative w-full max-w-xs sm:max-w-sm lg:max-w-none lg:w-64">
                                 <input
                                    type="text"
                                    placeholder="Search surveys..."
                                    value={heroSearchQuery}
