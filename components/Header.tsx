...
export const Header = ({ theme = "dark" }: { theme?: "light" | "dark" }) => {
  ...
  const handleLanguageChange = (langCode: string) => {
    ...
    // Here you could also save to localStorage or update a global state
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <div className="relative">
              <button
                ...
                className={`flex items-center gap-2 cursor-pointer px-3 py-2 rounded-full transition ${
                  isLight 
          ...
          >
            ...
            <div className="mt-4 space-y-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className={isLight ? "text-black" : "text-white"}>{t.search}</span>
              </div>
